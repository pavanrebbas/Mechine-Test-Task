...
const TextAdForm = () => {
    ...
    return (
        ...
        <Fragment>
            <Container>
                <form onSubmit={submitHandler} className="form my-5 py-5">
                    <div class="row ">
                        <div class="col">
                            <label className="form-label">Heading-1</label>
                            <input type="text" className="form-control" name="Heading1" placeholder="Add a heading that would make users intrested" /><br />
                            <label className="form-label">Heading-2</label>
                            <input type="text" className="form-control" name="Heading2" placeholder="Add a heading that would make users intrested" /><br />
