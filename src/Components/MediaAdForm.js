                ...
                <form onSubmit={submitHandler}>
                    <div class="row my-4">
                        <div class="col">
                            ...
                            <input type="text" className="form-control" value={Heading1} name="Heading1" onChange={onchagehandler} placeholder="Add a heading that would make users intrested" />
                            <br />
                            <label className="form-label">Heading-2</label>
                            <input type="text" className="form-control" value={Heading2} name="Heading2" onChange={onchagehandler} placeholder="Add a heading that would make users intrested" />
                            <br />
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control text-start" value={Description} name="Description" onChange={onchagehandler} placeholder="Add primary text to help users understand more about your products, services or offers" /><br />
